...
//    UserInfoDTO rDTO = (UserInfoDTO) request.getAttribute("rDTO");
    ...
    // 반환값이 Object 라 캐스팅 필요
    UserInfoService userInfoService = (UserInfoService) request.getAttribute("userInfoService");
    ...
    UserInfoDTO rDTO;
    try {
            rDTO = userInfoService.getUserInfo(pDTO);
        } catch (Exception e) {
...
<body>
<h2><%=CmmUtil.nvl(rDTO.getUserId())%> 회원의
    정보 상세보기
</h2>
<hr/>
<br/>
...
<div>
    <button id="doUpdate">수정하기</button>
</div>
